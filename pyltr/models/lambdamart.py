...
class LambdaMART(AdditiveModel):
    ...
    def fit(self, X, y, qids, monitor=None):
        ...
        n_stages = self._fit_stages(X, y, qids, y_pred, random_state, begin_at_stage, monitor)
    ...
    def score(self, qids, X, y):
        return self.metric.calc_mean_random(qids,y,self.predict(X))
